...
import 'file?name=[name].[ext]!./vendor/claraplayer-2.3.41.min.js'; // change claraplayer 2.3.3 to 2.3.80
import 'file?name=[name].[ext]!./vendor/three.js';
import 'file?name=[name].[ext]!./vendor/three.extra.js';
//import 'file?name=[name].[ext]!./vendor/claraplayer-2.2.27.js.map';
